...
const QUERIES = {
  leads: 'select=id,contact_name,company,email,phone,service,budget_range,stage,priority,score,source,source_detail,message,owner_id,form_id,landing_path,landing_url,referrer_url,utm_source,utm_medium,utm_campaign,utm_content,utm_term,click_id,assignment_rule_id,next_action_at,created_at&order=created_at.desc',
  ...
  form_submissions: 'select=id,lead_id,form_id,form_name,page_path,page_url,page_title,referrer_url,domain,utm_source,utm_medium,utm_campaign,utm_content,utm_term,created_at&order=created_at.desc&limit=250',
